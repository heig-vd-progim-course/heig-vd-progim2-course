...
- Focused on helping students develop problem-solving skills and a solid
...
- Students with varying levels of programming experience, from beginners to
  intermediate.
- Students who prefer clear, concise, and well-structured learning materials.
- Students who appreciate practical examples and hands-on exercises to reinforce
...
Use the main learning objectives of the course based on the main
...
The university requires all programs to integrate sustainability into their
curricula by 2030. This course follows the transversal approach recommended by
the university sustainability platform, where sustainability is woven into the
...
- Real-world relevance: Use practical examples with ecological and low-tech
  values
- English code: All variable names, function names, class names, and identifiers
  in code must be in English following language conventions (Java, etc.)
